            ...
            <form method="POST" action="/teacherupdate" enctype="multipart/form-data">
             ...
             <div class="form">
                ...
                <div class="inputfield">
                   ...
                   <input type="text" name="firstname" class="input"  value="{{$data['firstname']}}">
                </div>
                <div class="inputfield">
                 <label>Middle Name</label>
                 <input type="text" name="middlename" class="input" value="{{$data['middlename']}}">
              </div>   
                 <div class="inputfield">
                   <label>Last Name</label>
                   <input type="text" name="lastname" class="input" value="{{$data['lastname']}}">
                </div>  
                <div class="inputfield">
                   <label>Email</label>
